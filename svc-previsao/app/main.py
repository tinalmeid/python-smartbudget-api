"""
@file svc-previsao/app/main.py
@description: Ponto e entrada do svc-previsao.
Inicializa o servidor FastAPI, configura middlewares de CORS e registra os routers de previsão de gastos com Prophet e MLflow.
